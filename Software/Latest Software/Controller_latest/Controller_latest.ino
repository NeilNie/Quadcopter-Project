...
void setup() {
  ...
  for (int cal_int = 0; cal_int < 2000 ; cal_int ++) {                 //Run this code 2000 times
    if (cal_int % 125 == 0)lcd.print("."); digitalWrite(13, HIGH);                           //Print a dot on the LCD every 125 readings
  ...
  lcd.setCursor(0, 0);                                                 //Set the LCD cursor to position to position 0,0
  lcd.print("FR:");                                                 //Print text to screen
  lcd.setCursor(0, 1);                                                 //Set the LCD cursor to position to position 0,1
  lcd.print("RR:");                                                 //Print text to screen
...
void loop() {
  ...
  if (digitalRead(2) == HIGH) {
    ...
    if (micros() - loop_timer > 4050) {
      digitalWrite(13, HIGH);                  //Turn on the LED if the loop time exceeds 4050us.
    }
