...
void loop() {
  ...
  angle_pitch += gyro_x * 0.0000311;                                   //Calculate the traveled pitch angle and add this to the angle_pitch variable
  angle_roll += gyro_y * 0.0000311;                                    //Calculate the traveled roll angle and add this to the angle_roll variable
