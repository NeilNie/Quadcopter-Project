            ...
            case "ValueStringColumn":
                ...
                if let characteristic = item as? CBCharacteristic {
                    if let characteristicValue = characteristic.value {
                        if let characteristicString = NSString(data: characteristicValue, encoding: String.Encoding.utf8) as String? {
                    ...
                    if let descriptorValue = InfoModuleManager.parseDescriptorValue(descriptor) {//descriptor.value as? NSData{
                        if let descriptorString = NSString(data: descriptorValue, encoding: String.Encoding.utf8) as String? {
