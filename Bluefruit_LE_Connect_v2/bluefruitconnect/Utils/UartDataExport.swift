...
class UartDataExport {
    ...
    static func dataAsText(_ dataBuffer: [UartDataChunk]) -> String? {
        ...
        if (Preferences.uartIsInHexMode) {
            ...
            text = NSString(data:data, encoding: String.Encoding.utf8) as String?
        }
    ...
    static func dataAsCsv(_ dataBuffer: [UartDataChunk])  -> String? {
        ...
        for dataChunk in dataBuffer {
            ...
            if (Preferences.uartIsInHexMode) {
                ...
                dataString = NSString(data:dataChunk.data, encoding: String.Encoding.utf8) as String?
            }
            if (dataString == nil) {
                dataString = ""
            }
    ...
    static func dataAsJson(_ dataBuffer: [UartDataChunk])  -> String? {
        ...
        var result : String?
        if let data = data {
            result = NSString(data: data, encoding: String.Encoding.utf8) as? String
        }
